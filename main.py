...
def load_data():
    ...
    # Using the standard UCI file name 'Concrete_Data.xls'
...
def explore_data(df):
    ...
    # Extract correlations with the target (drop the target itself)
    target_corr = corr_matrix[target_col].drop(target_col)
    most_correlated_feature = target_corr.abs().idxmax()
